...
fn production_check_documents_release_readiness() {
    ...
    for expected in [
        ...
        "cargo test -p quic_tunnel_mobile_core --lib mobile_grant_",
        "cargo test -p quic_tunnel_mobile_core --test mobile_platform_wrappers",
        "cargo test -p quic_tunnel_sdk --test live_workflow",
        ...
        "--xcframework-output target/mobile-package-dry-run/ios/quic_tunnel_mobile_coreFFI.xcframework",
